    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="default-src * 'self' data: 'unsafe-inline' 'unsafe-eval' *; child-src * 'self' data: 'unsafe-inline' 'unsafe-eval' *; script-src * 'self' 'unsafe-inline' data: 'unsafe-inline' 'unsafe-eval' *"
        ></meta>
      </Head>
